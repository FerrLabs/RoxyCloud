  ...
  home: {
    ...
    status: {
      ...
      shipped: [
        ...
        "Le partage d'un dossier ou d'un fichier avec un autre compte de l'instance, en lecture ou en écriture, depuis l'application web, WebDAV et la synchronisation",
  ...
  "user": {
    ...
    endpoints: {
      ...
      rows: [
        ...
        ['PUT', '/v1/auth/password', 'Changer le sien, en donnant le mot de passe actuel'],
        ['GET', '/v1/users', "Tous les comptes, avec ce que chacun occupe (admin)"],
        ['POST', '/v1/users', 'En créer un (admin)'],
        ['POST', '/v1/users/{id}/disable', 'Fermer ses sessions et le refuser à la connexion (admin)'],
        ['POST', '/v1/users/{id}/enable', 'Le réactiver (admin)'],
        ...
        ['POST', '/v1/grants', "Partager un dossier ou un fichier avec l'un d'eux, en lecture ou en écriture"],
        ['GET', '/v1/grants/received', "Ce que d'autres comptes partagent avec celui-ci"],
        ['DELETE', '/v1/grants/{id}', 'Retirer un partage, ou quitter un partage reçu'],
        ['GET', '/v1/shares', 'Les liens publiés par ce compte'],
        ['POST', '/v1/shares', 'En publier un, son jeton affiché une seule fois'],
        ['DELETE', '/v1/shares/{id}', 'En révoquer un, avec effet immédiat'],
        ['GET', '/v1/public/{token}', "Ce qu'il y a derrière un lien, et son listage"],
        ['GET', '/v1/public/{token}/entries/{*path}', 'Idem, pour ce qui se trouve dessous'],
        ['GET', '/v1/public/{token}/content', 'Télécharger ce que le lien désigne'],
        ['GET', '/v1/public/{token}/content/{*path}', 'Télécharger ce qui se trouve dessous'],
      ],
    },
    transfers: {
