  ...
  home: {
    ...
    status: {
      ...
      shipped: [
        ...
        'Sharing a folder or a file with another account on the instance, to view or to edit, over the web app, WebDAV and sync',
...
curl --fail http://localhost:3001/health`,
      ...
      note: 'The two bootstrap variables only do something on an empty database, where they create the first administrator. Take them back out of the environment once that has happened: every account after the first is created through the API by an administrator.',
    },
    source: {
      heading: 'From source',
