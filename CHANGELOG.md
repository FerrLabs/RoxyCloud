...
- fix(desktop): let the window's CSP apply the app's styles (#210)
...
- fix(cli): state what a held path means without naming a permission (#148)

## [0.25.1] - 2026-09-19

### Bug Fixes

- fix(client): set a read-only conflict aside and still bring the owner's version down (#147)
...
- feat(api): resumable uploads (#107)
...
- feat(api): search nodes by name (#94)

## [0.19.1] - 2026-09-06

### Bug Fixes

- fix(api): limit how fast a password may be guessed (#93)
